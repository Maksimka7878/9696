        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="space-y-10 relative z-20">
            ...
            <div className="text-gray-300 text-lg md:text-xl font-light leading-relaxed space-y-6">
              <p>
                Гримерка 96 — это индустриальный ритм, выкованный в 96-м. Студия Валерия Волошина не просто играет музыку, мы создаем <strong className="text-white font-semibold">звуковую архитектуру</strong>.
              </p>
              <p>
                Эксперименты с металлоломом переросли в барабанное шоу мирового уровня. Синхронная точность, визуальный спектакль и нефильтрованный адреналин — это то, чем отличается Гримерка 96.
              </p>
            </div>
          ...
          <div className="relative h-[300px] sm:h-[400px] md:h-[600px] w-full perspective-1000 mt-12 lg:mt-0">
            ...
            <div className="absolute inset-0 sm:inset-4 md:inset-12 z-20 bg-brand-black border border-white/10 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500 overflow-hidden group">
              ...
              <img
                ...
                alt="Гримерка 96 барабанное шоу — выступление коллектива студии Валерия Волошина"
            ...
            <div className="absolute top-[-20px] left-[-20px] md:top-0 md:left-0 w-32 h-32 md:w-48 md:h-48 z-30 animate-float-slow drop-shadow-[0_20px_30px_rgba(0,0,0,0.5)]">
              <img
                ...
                alt="Гримерка 96 — ударные инструменты перкуссионного шоу"
              />
            ...
            {/* Floating Baraban (Top Right - Above Main Photo) */}
            <div className="absolute top-[-30px] right-[-30px] md:top-[-40px] md:right-[-40px] w-40 h-40 md:w-56 md:h-56 z-30 animate-float-slower drop-shadow-[0_20px_30px_rgba(0,0,0,0.5)]">
              <img
                ...
                style={{ clipPath: 'circle(50%)' }}
                alt="Барабан Гримерка 96 — студия Валерия Волошина"
              />
            </div>
